import { world, Player, system, EntityInventoryComponent, ItemStack } from '@minecraft/server';
...
function swordPower(player: Player) {
	if (!player.removeTag('swordPower')) return
